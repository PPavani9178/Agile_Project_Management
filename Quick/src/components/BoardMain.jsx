        ...
        <div className='flex flex-col w-full' style={{backgroundColor:`${bdata.bgcolor}`}}>
            ...
            <div className='flex flex-col w-full flex-grow relative'>
                ...
                {bdata.list && bdata.list.map((x,ind)=>{
                   return <div key={ind} className='mr-3 w-60 h-fit rounded-md p-2 bg-white flex-shrink-0'>
                    <div className="list-body">
                        ...
                        {(provided, snapshot) => (
                            ...
                            {(provided, snapshot) => (
                              ...
                              >
                                <div className="item flex justify-between items-center bg-white p-1 cursor-pointer rounded-md border-2 border-zinc-900 hover:border-blue-500">
                        ...
                        <BoardCardAdd getcard={(e)=>cardData(e,ind)}></BoardCardAdd>
                    </div>
                </div>
                })
                }
                ...
                <BoardAddList getlist={(e)=>listData(e)}></BoardAddList>
