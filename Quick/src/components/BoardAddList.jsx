...
const BoardAddList = (props) => {
    ...
    return (
        <div>
            ...
            {show && <div>
                <textarea value={list} onChange={(e)=>setlist(e.target.value)} className='p-1 w-full rounded-md border-2 bg-white border-zinc-900 font-serif' name="" id="" cols="30" rows="2" placeholder='Enter list Title...'></textarea>
